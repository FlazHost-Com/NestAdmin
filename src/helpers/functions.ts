...
export function paginate<T>(
  ...
  const page_size = parseInt(filter.page_size || filter.q_page_size || '10', 10) || 10
...
export function ciLike(col: string, param: string, val: string): [string, Record<string, string>] {
...
export function removePrefix(obj: Record<string, any>, prefix: string): Record<string, any> {
  return Object.fromEntries(
    Object.entries(obj)
