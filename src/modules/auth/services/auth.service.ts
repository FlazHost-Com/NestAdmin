...
import { UnauthorizedError, NotFoundError, AppError } from '../../../errors/AppError'
...
export class AuthService {
  ...
  async processOTP(email: string, otp: string, newPassword: string): Promise<void> {
    const user = await this.userRepo.findOne({ where: { email } })
