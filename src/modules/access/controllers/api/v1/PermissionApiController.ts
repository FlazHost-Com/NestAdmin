...
export class PermissionApiController {
  constructor(private permissionService: PermissionService) {
    ...
    routeRegistry.register('api.v1.access.permission.store',          'POST',   `/${BASE}`)
    routeRegistry.register('api.v1.access.permission.show',           'GET',    `/${BASE}/:id`)
    routeRegistry.register('api.v1.access.permission.update',         'PUT',    `/${BASE}/:id`)
    routeRegistry.register('api.v1.access.permission.delete',         'DELETE', `/${BASE}/:id`)
    routeRegistry.register('api.v1.access.permission.delete_selected','POST',   `/${BASE}/delete_selected`)
    routeRegistry.register('api.v1.access.permission.sync',           'POST',   `/${BASE}/sync`)
  }
