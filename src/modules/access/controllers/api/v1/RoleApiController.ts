import { Controller, Get, Post, Put, Delete, Param, Req, Body, UseGuards } from '@nestjs/common'
...
export class RoleApiController {
  constructor(private roleService: RoleService) {
    ...
    routeRegistry.register('api.v1.access.role.delete',         'DELETE', `/${BASE}/:id`)
    routeRegistry.register('api.v1.access.role.delete_selected','POST',   `/${BASE}/delete_selected`)
    routeRegistry.register('api.v1.access.role.permission',     'GET',    `/${BASE}/:id/permission`)
    routeRegistry.register('api.v1.access.role.permission.assign',          'POST', `/${BASE}/:id/permission/:permission_id/assign`)
    routeRegistry.register('api.v1.access.role.permission.unassign',        'DELETE', `/${BASE}/:id/permission/:permission_id/unassign`)
    routeRegistry.register('api.v1.access.role.permission.assign_selected', 'POST', `/${BASE}/:id/permission/assign_selected`)
    routeRegistry.register('api.v1.access.role.permission.unassign_selected','POST',`/${BASE}/:id/permission/unassign_selected`)
  }
