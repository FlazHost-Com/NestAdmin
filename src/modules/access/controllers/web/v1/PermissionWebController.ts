...
export class PermissionWebController {
  constructor(private permissionService: PermissionService) {
    ...
    routeRegistry.register('admin.v1.access.permission.create',         'GET',    `${BASE}/create`)
    routeRegistry.register('admin.v1.access.permission.store',          'POST',   BASE)
    routeRegistry.register('admin.v1.access.permission.edit',           'GET',    `${BASE}/:id/edit`)
    routeRegistry.register('admin.v1.access.permission.update',         'PUT',    `${BASE}/:id`)
    routeRegistry.register('admin.v1.access.permission.delete',         'DELETE', `${BASE}/:id`)
    routeRegistry.register('admin.v1.access.permission.delete_selected','POST',   `${BASE}/delete_selected`)
    routeRegistry.register('admin.v1.access.permission.sync',           'POST',   `${BASE}/sync`)
  }
  ...
  async create(@Req() req: Request, @Res() res: Response) {
    res.render('access/views/be/default/permissions/create', { title: 'Create Permission' })
  }
  ...
  async edit(@Param('id') id: string, @Req() req: Request, @Res() res: Response) {
    ...
    delete (req.session as any).errors
    delete (req.session as any).old
    res.render('access/views/be/default/permissions/edit', { title: 'Edit Permission', data })
  }
  ...
  async deleteSelected(@Body() body: any, @Req() req: Request, @Res() res: Response) {
