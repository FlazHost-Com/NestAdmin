...
export class UserWebController {
  constructor(private userService: UserService) {
    ...
    routeRegistry.register('admin.v1.access.user.create',         'GET',    `${BASE}/create`)
    routeRegistry.register('admin.v1.access.user.store',          'POST',   BASE)
    routeRegistry.register('admin.v1.access.user.edit',           'GET',    `${BASE}/:id/edit`)
    routeRegistry.register('admin.v1.access.user.update',         'PUT',    `${BASE}/:id`)
    routeRegistry.register('admin.v1.access.user.delete',         'DELETE', `${BASE}/:id`)
    routeRegistry.register('admin.v1.access.user.delete_selected','POST',   `${BASE}/delete_selected`)
  }
