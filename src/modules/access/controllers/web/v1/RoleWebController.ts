...
export class RoleWebController {
  constructor(private roleService: RoleService) {
    ...
    routeRegistry.register('admin.v1.access.role.create',                    'GET',    `${BASE}/create`)
    routeRegistry.register('admin.v1.access.role.store',                     'POST',   BASE)
    routeRegistry.register('admin.v1.access.role.edit',                      'GET',    `${BASE}/:id/edit`)
  ...
  async create(@Req() req: Request, @Res() res: Response) {
    res.render('access/views/be/default/roles/create', { title: 'Create Role' })
  }
  ...
  async edit(@Param('id') id: string, @Req() req: Request, @Res() res: Response) {
    ...
    delete (req.session as any).errors
    delete (req.session as any).old
    res.render('access/views/be/default/roles/edit', { title: 'Edit Role', data })
  }
  ...
  async permission(@Param('id') id: string, @Req() req: Request, @Res() res: Response) {
    const filter = req.query as Record<string, any>
